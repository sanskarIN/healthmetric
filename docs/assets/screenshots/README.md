...
Desktop release artifacts do not reuse this Android screenshot set. Any future desktop marketing screenshots must be captured from the real desktop client on the target operating system and pass the same fictional-data and privacy review rules.
