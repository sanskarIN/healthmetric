...
Describe the user-visible improvements in this release, grouped by Android, desktop, and shared-core changes where relevant.
...
Describe accessibility improvements and manual verification performed on each platform being published.
...
- [ ] Connected Android UI tests passed on the release-candidate emulator/device.
